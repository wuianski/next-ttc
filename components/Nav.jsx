  ...
  return (
    <>
      <div>
        ...
        <div>
          <Box className={styles.primaryNav} onClick={handleOpen}>
      ...
      >
        ...
        >
          ...
          <Box className={styles.primaryNav} onClick={handleClose}>
          ...
          >
            ...
            >
              ...
              <div className={styles.menuLink}>
                <a href={`mailto:` + contact.content} target=" blank">
                  Contact
                </a>
              </div>
              <Link href="/2D">
              ...
              <div>
                {works.map((work) => (
                  <div key={work.id}>
                    ...
                    <Box
                      className={styles.menuWorksLink}
                      sx={{
